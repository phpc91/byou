	...
	<ul id="cs-slider-ul" style="min-height:<?php echo $slider_height; ?>px;">
		...
		foreach ( $slider_items as $item ) {
			...
			?>
			 ...
			 <li<?php echo $slide_data; ?> class="cs-layout-<?php echo $slide_layout; ?>" <?php echo $style; ?> id="slider-content-<?=$id?>">
				...
				<div class="<?php echo $content_class; ?> col cs-content">
					...
					<?php } if ( !empty( $item_data['description'] ) ) {
							...
							?><p id="slider-description-<?=$id?>" class="cs-element" <?php echo $inline_style; ?>><?php echo do_shortcode($item_data['description']); ?></p>
							<p class="clear"></p>
